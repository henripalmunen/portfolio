...
FieldDescription = _reflection.GeneratedProtocolMessageType('FieldDescription', (_message.Message,), {
...
FunctionDefinition = _reflection.GeneratedProtocolMessageType('FunctionDefinition', (_message.Message,), {
...
Dual = _reflection.GeneratedProtocolMessageType('Dual', (_message.Message,), {
  'DESCRIPTOR' : _DUAL,
  '__module__' : 'ServerSideExtension_pb2'
...
BundledRows = _reflection.GeneratedProtocolMessageType('BundledRows', (_message.Message,), {
...
ScriptRequestHeader = _reflection.GeneratedProtocolMessageType('ScriptRequestHeader', (_message.Message,), {
...
FunctionRequestHeader = _reflection.GeneratedProtocolMessageType('FunctionRequestHeader', (_message.Message,), {
...
CommonRequestHeader = _reflection.GeneratedProtocolMessageType('CommonRequestHeader', (_message.Message,), {
...
TableDescription = _reflection.GeneratedProtocolMessageType('TableDescription', (_message.Message,), {
...
_CONNECTOR = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='qlik.sse.Connector.GetCapabilities',
    index=0,
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='qlik.sse.Connector.ExecuteFunction',
    index=1,
    containing_service=None,
    input_type=_BUNDLEDROWS,
    output_type=_BUNDLEDROWS,
    serialized_options=None,
    create_key=_descriptor._internal_create_key,
  ),
  _descriptor.MethodDescriptor(
    name='EvaluateScript',
    full_name='qlik.sse.Connector.EvaluateScript',
    index=2,
    containing_service=None,
    input_type=_BUNDLEDROWS,
    output_type=_BUNDLEDROWS,
...
class Connector(object):
    ...
    def GetCapabilities(request,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.unary_unary(request, target, '/qlik.sse.Connector/GetCapabilities',
    ...
    def ExecuteFunction(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/qlik.sse.Connector/ExecuteFunction',
            BundledRows.SerializeToString,
            BundledRows.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)
    ...
    def EvaluateScript(request_iterator,
            ...
            timeout=None,
            metadata=None):
        return grpc.experimental.stream_stream(request_iterator, target, '/qlik.sse.Connector/EvaluateScript',
            BundledRows.SerializeToString,
            BundledRows.FromString,
            options, channel_credentials,
            insecure, call_credentials, compression, wait_for_ready, timeout, metadata)